...
- reference inputs exist but `deck-protocol.json.assets` is empty or no page binds localized assets;
- `deck-protocol.review.md` has not been generated before protocol confirmation;
